    ...
    private function setReplicaSettings(array $replicas)
    {
        ...
        foreach ($replicas as $indexName => $replica) {
            if ($replica instanceof IndexReplicaSettings) {
                ...
                $replica = new IndexReplicaSettings($replica);
                ...
                throw new \InvalidArgumentException(
                    'The replica settings should be an array or an instance of IndexReplicaSettings'
                );
            } else {
                $replica = new IndexReplicaSettings($indexName, $replica);
            }
